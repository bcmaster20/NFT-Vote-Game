...
async function main() {
  ...
  await redContract.transferOwnership(gameLogic.address);
  await blueContract.transferOwnership(gameLogic.address);
  await yellowContract.transferOwnership(gameLogic.address);
  await greenContract.transferOwnership(gameLogic.address);
...
function saveFrontendFiles(contracts) {
  ...
  contracts.forEach((c) => {
    ...
    const ContractArtifact = hre.artifacts.readArtifactSync(c.name);
    fs.writeFileSync(
