...
//        uint256 nextPrice = currentNFT.oldSupply + 1 > 0 ? price + (price / 5) : price;
        ...
        require(currentNFT.oldSupply < nextRound, "Round ended");
        ...
        // if the nextRound th NFT is minted there is a winning color
        if (currentNFT.oldSupply == nextRound) {
    ...
    function claimReward() external payable nonReentrant {
        ...
        // 4.9- (2.578947)
        _asyncTransfer(msg.sender, (currentRoundPool - ((currentRoundPool / votersInRound) * nextRound))/nextRound);
